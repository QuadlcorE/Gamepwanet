...
import SteamDeckConsole from "../components/3D/steamdeck";
    ...
    <>
      ...
      <div className="min-h-screen bg-black text-white">
        ...
        <main className="mx-auto flex min-h-[calc(100vh-88px)] w-full max-w-6xl items-center justify-center px-6 py-10">
          ...
          <section className="absolute z-10 grid w-full max-w-5xl overflow-hidden rounded-[2rem] border border-white/10 shadow-[0_30px_120px_rgba(0,0,0,0.45)] lg:grid-cols-[1.15fr_0.85fr]">
            <div className="flex flex-col justify-between bg-[radial-gradient(circle_at_top_left,rgba(34,197,94,0.35),transparent_35%),linear-gradient(135deg,rgba(255,255,255,0.08),rgba(255,255,255,0.02))] p-8 lg:p-12">
              <div>
                ...
                <p className="mt-4 max-w-md text-base text-white/70">
                  Sign in to keep your game picks, wishlist, and favorites close
                  at hand.
                </p>
              </div>
              <p className="mt-10 text-sm text-white/55">
                New here?{" "}
                <Link
                  className="text-emerald-200 transition-opacity hover:opacity-80"
                  to="/signup"
                >
                  Create an account
                </Link>
