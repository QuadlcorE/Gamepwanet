            ...
            {isMenuOpen ? (
              <div className="absolute right-0 top-14 z-20 w-64 rounded-3xl border border-white/10 bg-neutral-950/95 p-4 shadow-2xl backdrop-blur">
                ...
                <button
                  ...
                  className="mt-4 flex w-full items-center justify-center gap-2 rounded-2xl bg-white px-4 py-3 text-sm font-semibold text-black transition-opacity hover:opacity-85"
                >
